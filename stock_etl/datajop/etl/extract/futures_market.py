        ...
        for idx, ops in enumerate(ops_list):
            for op in ops:
                if idx == 0 :
                    ...
                    rows.append(op.findAll('td')[5].text.replace('%',''))
                ...
                if idx == 1 :
                    ...
                    rows.append(op.findAll('td')[4].text.replace('%',''))
        ...
        res_non_metal = {
            'meta':{
                ...
                'cols':{
                    ...
                    'fluctuation_rate':'등락율', 'is_rise':'상승여부'
                },
                'std_day':cal_std_day(0),
        ...
        for idx,ops in enumerate(ops_list) :
            for op in ops:
                ...
                if idx ==  0:
                    ...
                    rows.append(op.findAll('td')[1].text)
                    rows.append(op.findAll('td')[2].text.replace(',',''))
                    rows.append(op.findAll('td')[-2].text[:-1].replace(' ','').replace('%',''))
                    if op['class'][0] == 'down' :
                        rows.append(0)
                        tmp = dict(zip(cols,rows))
                        data_oil.append(tmp)
                ...
                if idx == 1 :
                    ...
                    rows.append(op.findAll('td')[1].text)
                    rows.append(op.findAll('td')[2].text.replace(',',''))
                    rows.append(op.findAll('td')[-2].text.replace(' ','').replace('%',''))
                    if op['class'][0] == 'down' :
                        rows.append(0)
                        tmp = dict(zip(cols,rows))
